    ...
    <div className="bg-[#F7F8FA] min-h-screen flex items-center justify-center">
      <div className="w-[520px] h-[646px] border bg-white rounded-lg shadow-sm p-[60px] font-inter">
        ...
        <div className="grid grid-cols-3 gap-5 my-8">
          {/* facebook */}
          <button className="bg-[#4064AC] rounded-md flex items-center justify-center h-[45px]">
            <svg
          ...
          {/* Google */}
          <button className="bg-[#D64937] rounded-md flex items-center justify-center h-[45px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
