            ...
            <div className="p-4 border border-gray-300 rounded-lg shadow-sm">
              ...
              <div className="w-full">
                <input
                  ...
                  className="flex-grow w-full px-5 py-3 text-primary-heading font-inter text-base border border-primary-blue bg-athens_gray rounded-md focus:outline-none mb-4"
                />
              </div>
              {/* Upload Section */}
              {/* <label
